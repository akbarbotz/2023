...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://i.ibb.co/z8SrpqL/20211022-131643.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `*Link YT:* https://youtube.com/shorts/3TlR5wWlJdg?si=sDJj8TiacUS_bO2Y`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
...
"sellerJid": "919360596007@s.whatsapp.net",
...
case 'gcbug' : {
if (!isPremium) return replygcxeon(mess.prem)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/Cxpp01zY8ECLujUpPcKN6o`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
